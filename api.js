const PROJECT_ID = "SKEXF8mkdiitjt9QqWBIMieWuw7Ajd6UHc";
const PROJECT_SECRET = "a2gyYjJpSVBWYXo3YnhXQjBpMkt5ZEFSVXlMTlRKMTM=";
...
class API {
  ...
  async createRoom(roomName) {
    const uniqueName = Math.random().toFixed(4);
